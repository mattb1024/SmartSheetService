...
namespace SmartSheetWindowsService
{
    ...
    /// </summary>
    internal class SmartSheetJobListener : IJobListener
    {
        ...
        /// <summary>
        /// Initialises a new instance of the SmartSheetJobListener class.
        /// </summary>
        /// <param name="provider">Container provider instance.</param>
        public SmartSheetJobListener(IContainerProvider provider)
        {
            if (provider == null)
                throw new ArgumentNullException("provider");

            this._provider = provider;
            this.Name = "SmartSheetJobListener";
        }
